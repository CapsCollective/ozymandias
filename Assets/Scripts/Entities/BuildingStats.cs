...
public class BuildingStats : MonoBehaviour
{
    ...
    public float CostScale
    {
        get {
            switch (scaleSpeed)
            {
                case ScaleSpeed.Slow: return 1.15f; break;
                case ScaleSpeed.Medium: return 1.20f; break;
                case ScaleSpeed.Fast: return 1.25f; break;
                case ScaleSpeed.Special: return 1.5f; break;
                default: return 1;
            }
        }
    }
