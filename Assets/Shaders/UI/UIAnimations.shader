...
Shader "UIAnimations"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			uniform float4 _DefenseColor;
			uniform float4 _ThreatColor;
			uniform float _SliderMin;
			uniform float _SliderMax;
			uniform float _Float1;
			uniform float _Stability;
			uniform float _PanSpeed;
			uniform float _ShadingMultiplier;
			...
			uniform float _ShadingFract;
			uniform float _ThreatShadingOffset;
			uniform float _ShadingAngle2;
			uniform float _DefenseShadingOffset;
			uniform float _ShadingAngle;
			uniform float _ShadingPower;
			uniform float _YShadingOffset;
			uniform float _YShadingPower;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 DefenceColors302 = _DefenseColor;
				float4 ThreatColors303 = _ThreatColor;
				float lerpResult108 = lerp( _SliderMin , ( _SliderMax + ( _Float1 * 0.5 ) ) , _Stability);
				...
				float3 temp_output_316_0 = (lerpResult190).rgb;
				float3 temp_output_486_0 = ( temp_output_316_0 * _ShadingMultiplier );
				...
				float3 break436 = saturate( PackedMaskedMasks251 );
				float2 texCoord439 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult478 = (float2(frac( ( texCoord439.x * _ShadingFract ) ) , texCoord439.y));
				float2 appendResult499 = (float2(0.0 , _ThreatShadingOffset));
				float cos480 = cos( radians( _ShadingAngle2 ) );
				float sin480 = sin( radians( _ShadingAngle2 ) );
				float2 rotator480 = mul( appendResult478 - appendResult499 , float2x2( cos480 , -sin480 , sin480 , cos480 )) + appendResult499;
				float2 appendResult497 = (float2(0.0 , _DefenseShadingOffset));
				float cos442 = cos( radians( _ShadingAngle ) );
				float sin442 = sin( radians( _ShadingAngle ) );
				float2 rotator442 = mul( appendResult478 - appendResult497 , float2x2( cos442 , -sin442 , sin442 , cos442 )) + appendResult497;
				float2 saferPower458 = abs( ( 1.0 - ( texCoord439.x > 0.5 ? rotator480 : rotator442 ) ) );
				float2 temp_cast_0 = (_ShadingPower).xx;
				float2 appendResult494 = (float2(0.0 , _YShadingOffset));
				float2 texCoord492 = IN.texcoord.xy * float2( 1,1 ) + appendResult494;
				float saferPower502 = abs( texCoord492.y );
				float2 appendResult491 = (float2(( saturate( ( break436.x + break436.z ) ) * pow( saferPower458 , temp_cast_0 ).x ) , saturate( ( 1.0 - pow( saferPower502 , _YShadingPower ) ) )));
				float2 UVTest448 = appendResult491;
				float2 break487 = UVTest448;
				float3 lerpResult459 = lerp( temp_output_316_0 , temp_output_486_0 , break487.x);
				float3 lerpResult506 = lerp( temp_output_316_0 , temp_output_486_0 , max( break487.x , break487.y ));
				...
				float3 lerpResult354 = lerp( max( lerpResult459 , lerpResult506 ) , float3(0,0,0) , Shadowmask353);
				float3 Color100 = saturate( lerpResult354 );
				float3 temp_cast_1 = (_ShadowMask).xxx;
				float3 appendResult210 = (float3(temp_output_83_0 , temp_output_92_0 , temp_output_88_0));
				float3 PackedMasks211 = appendResult210;
				float3 smoothstepResult416 = smoothstep( float3( 0,0,0 ) , temp_cast_1 , (PackedMasks211).xyz);
...
/*ASEBEGIN
Version=18921
1928;-8;1920;1059;10048.58;4562.142;8.704892;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-1587.176,-1230.145;Inherit;False;Property;_Cutoff;Cutoff;9;0;Create;True;0;0;0;False;0;False;0;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;468;-5077.385,883.0548;Inherit;False;Property;_ShadingFract;Shading Fract;25;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;444;-4856.366,1388.739;Inherit;False;Property;_ShadingAngle;Shading Angle;23;0;Create;True;0;0;0;False;0;False;60;60;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;469;-4641.628,905.89;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;500;-4924.838,1289.389;Inherit;False;Property;_ThreatShadingOffset;Threat Shading Offset;29;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;498;-4898.338,1181.389;Inherit;False;Property;_DefenseShadingOffset;Defense Shading Offset;28;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;482;-4881.936,1503.569;Inherit;False;Property;_ShadingAngle2;Shading Angle 2;24;0;Create;True;0;0;0;False;0;False;-60;60;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;493;-4331.081,1522.016;Inherit;False;Property;_YShadingOffset;Y Shading Offset;27;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;435;-3730.162,658.9861;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;301;-2367.727,1013.999;Inherit;False;Property;_PanSpeed;Pan Speed;13;0;Create;True;0;0;0;False;0;False;0;0.15;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;457;-3840.347,1203.201;Inherit;False;Property;_ShadingPower;Shading Power;22;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;503;-3910.655,1486.715;Inherit;False;Property;_YShadingPower;Y Shading Power;30;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-1880.631,593.0428;Inherit;False;Property;_Stability;Stability;0;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;291;-135.1198,12.37366;Inherit;False;Property;_ThreatColor;Threat Color;15;0;Create;True;0;0;0;False;0;False;0.7924528,0,0,1;0.7924528,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;285;-144.9173,-838.5121;Inherit;False;Property;_DefenseColor;Defense Color;14;0;Create;True;0;0;0;False;0;False;0,0.3496235,0.702,1;0,0.3496235,0.702,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;338;-3129.858,424.9841;Inherit;False;Property;_Float4;Float 4;18;0;Create;True;0;0;0;False;0;False;4.2;5.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;336;-3109.724,496.1272;Inherit;False;Property;_Float3;Float 3;17;0;Create;True;0;0;0;False;0;False;15.21;14.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;410;803.9075,249.0453;Inherit;False;Property;_ShadowMask;Shadow Mask;19;0;Create;True;0;0;0;False;0;False;0;-1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;485;-275.0305,846.2801;Inherit;False;Property;_ShadingMultiplier;Shading Multiplier;26;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;355;-303.2048,415.4672;Inherit;False;353;Shadowmask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;426;1615.559,33.94904;Inherit;False;Property;_Shadow1;Shadow 1;20;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;431;1773.559,52.94904;Inherit;False;Property;_Shadow2;Shadow 2;21;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;103;1192.966,-74.85251;Inherit;False;101;Mask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;432;1538.188,278.0194;Inherit;False;251;PackedMaskedMasks;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;297;-1062.717,-247.8733;Inherit;False;Property;_BarSmoothing;Bar Smoothing;12;0;Create;True;0;0;0;False;0;False;0;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;424;2121.559,109.949;Inherit;False;FLOAT4;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;327;-461.6021,1043.903;Inherit;False;Property;_Float0;Float 0;16;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C01BD788820B54AA6246DF20577E2E243BAA4858