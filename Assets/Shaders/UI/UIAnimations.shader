...
Shader "UIAnimations"
{
	Properties
	{
		...
		_BarSmoothing("Bar Smoothing", Float) = 0
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float smoothstepResult293 = smoothstep( _BarSmoothing , 1.0 , break278.x);
				...
				float4 DefenceColors302 = lerpResult283;
				...
				float smoothstepResult294 = smoothstep( _BarSmoothing , 1.0 , break278.z);
				float4 lerpResult290 = lerp( color291 , color292 , ( step( smoothstepResult294 , 0.0 ) * break282.z ));
				float4 ThreatColors303 = lerpResult290;
				...
				float3 Color100 = saturate( (lerpResult190).rgb );
				float4 appendResult317 = (float4(Color100 , Mask101));
				
				half4 color = appendResult317;
...
/*ASEBEGIN
Version=18921
-138;318;1920;1004;1157.602;-566.9026;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;297;-980.8235,-227.7355;Inherit;False;Property;_BarSmoothing;Bar Smoothing;12;0;Create;True;0;0;0;False;0;False;0;0.99;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;304;-635.6731,742.342;Inherit;False;303;ThreatColors;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;305;-641.6731,655.342;Inherit;False;302;DefenceColors;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;316;-284.4873,743.9601;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;218;1057.665,-181.3562;Inherit;False;100;Color;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;104;1227.12,-168.1612;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;317;1384.473,-100.2525;Inherit;False;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.LerpOp;324;-70.60205,697.9026;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;310;-668.5956,960.4507;Inherit;False;101;Mask;1;0;OBJECT;;False;1;FLOAT;0
...
WireConnection;317;0;218;0
WireConnection;317;3;103;0
WireConnection;324;2;326;0
WireConnection;129;0;56;0
WireConnection;130;0;91;0
WireConnection;326;0;310;0
WireConnection;326;1;327;0
WireConnection;3;0;317;0
ASEEND*/
//CHKSM=67388B039EFB2F7E737403FC42E3CA3EFA5E94D7