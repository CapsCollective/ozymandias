...
Shader "UIAnimations"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			uniform half _Stability;
			uniform half _PanSpeed;
			...
			uniform half _ShadowMask;
			uniform half _Shadow1;
			uniform half _Shadow2;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				half lerpResult108 = lerp( _SliderMin , ( _SliderMax + ( _Float1 * 0.5 ) ) , _Stability);
				half2 appendResult50 = (half2(0.0 , _PanSpeed));
				...
				half smoothstepResult42 = smoothstep( lerpResult108 , ( lerpResult108 + ( _Float1 * simplePerlin2D44 ) ) , texCoord19.x);
				...
				half2 break487 = UVTest448;
				half3 lerpResult459 = lerp( temp_output_316_0 , temp_output_486_0 , break487.x);
				half3 lerpResult506 = lerp( temp_output_316_0 , temp_output_486_0 , max( break487.x , break487.y ));
				...
				half3 lerpResult354 = lerp( max( lerpResult459 , lerpResult506 ) , half3(0,0,0) , Shadowmask353);
				half3 Color100 = saturate( lerpResult354 );
				half3 temp_cast_1 = (_ShadowMask).xxx;
				half3 appendResult210 = (half3(temp_output_83_0 , temp_output_92_0 , temp_output_88_0));
				half3 PackedMasks211 = appendResult210;
				half3 smoothstepResult416 = smoothstep( float3( 0,0,0 ) , temp_cast_1 , (PackedMasks211).xyz);
				half3 break420 = saturate( smoothstepResult416 );
				half3 lerpResult422 = lerp( float3( 0.01,0.01,0.01 ) , Color100 , saturate( pow( pow( saturate( ( break420.x + break420.y + break420.z ) ) , _Shadow1 ) , _Shadow2 ) ));
				half4 appendResult120 = (half4(lerpResult422 , Mask101));
...
/*ASEBEGIN
Version=18921
1913;0;1920;1053;10048.58;4536.027;8.704892;True;False
...
ASEEND*/
//CHKSM=CD9BD0A71CE456736840111EA1AA870702B9AF8D