...
Shader "Water"
{
	Properties
	{
		...
		_FlowCoverage("Flow Coverage", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		inline float4 TriplanarSampling627( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
		{
			float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
			projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
			float3 nsign = sign( worldNormal );
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 id42 = 0;
			float2 uv42 = 0;
			float voroi42 = voronoi42( coords42, time42, id42, uv42, 0, voronoiSmoothId42 );
			...
			float temp_output_596_0 = ( ( 1.0 - _Time.y ) * _WaterfallSpeed );
			float temp_output_634_0 = ( 1.0 - temp_output_596_0 );
			float3 appendResult631 = (float3(0.0 , temp_output_634_0 , temp_output_634_0));
			float4 triplanar627 = TriplanarSampling627( _NoiseTexture, ( ase_worldPos + appendResult631 ), ase_worldNormal, 1.0, float2( 0.1,0.01 ), 1.0, 0 );
			float dotResult579 = dot( (i.vertexColor).rgb , float3(0,1,0) );
			float dotResult616 = dot( (i.vertexColor).rgb , float3(1,0,0) );
			float4 lerpResult619 = lerp( saturate( ( lerpResult48 + Reflection487 + ( 1.0 - step( ( triplanar627.x * dotResult579 ) , _FlowCoverage ) ) ) ) , float4( 0,0,0,0 ) , dotResult616);
...
/*ASEBEGIN
Version=18921
1858;28;1920;871;2870.971;-803.3349;1.540403;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;597;-1054.695,-1235.883;Inherit;False;Property;_WaterfallSpeed;Waterfall Speed;18;0;Create;True;0;0;0;False;0;False;0;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;594;-1001.326,-1350.669;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;596;-834.6953,-1285.883;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;634;-886.1609,-1538.389;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;631;-650.3252,-1637.026;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.VoronoiNode;42;-2456.295,-928.8101;Inherit;True;0;1;1;3;1;False;3;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0.26;False;2;FLOAT;5;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.WorldPosInputsNode;632;-674.3252,-1838.026;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;633;-448.3252,-1664.026;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;587;-479.0092,-1316.938;Inherit;False;584;NoiseTex;1;0;OBJECT;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.Vector3Node;580;-558.5629,-880.5609;Inherit;False;Constant;_VectorDot2;Vector Dot 2;17;0;Create;True;0;0;0;False;0;False;0,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TriplanarNode;627;-263.3252,-1548.026;Inherit;True;Spherical;World;False;Top Texture 1;_TopTexture1;white;-1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;0.1,0.01;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;599;134.1718,-821.5047;Inherit;False;Property;_FlowCoverage;Flow Coverage;20;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;192;-1262.553,-192.9543;Inherit;False;Property;_FarColor;Far Color;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.0980388,0.5254902,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;6;-1219.869,-365.8822;Inherit;False;Property;_CloseColor;Close Color;0;0;Create;True;0;0;0;False;0;False;0,0.7231321,1,0;0.2909911,0.8034456,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;48;-651.714,-347.1151;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;301;337.6958,-359.6437;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector3Node;618;-557.355,-538.9266;Inherit;False;Constant;_VectorDot1;Vector Dot 1;17;0;Create;True;0;0;0;False;0;False;1,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.VertexColorNode;620;689.2914,-13.5183;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TransformDirectionNode;446;-75.96971,1125.663;Inherit;False;World;Tangent;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;451;867.3881,1089.603;Inherit;False;Step Antialiasing;-1;;67;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;447;-459.0977,1268.245;Inherit;False;NormalFromHeightSwiggies;-1;;65;5503043ebd93333488a25a0ccd478405;0;1;13;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;300;-148.8056,1289.752;Inherit;False;Blinn-Phong Half Vector;-1;;66;91a149ac9d615be429126c95e20753ce;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;593;-550.3258,-1246.669;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;381;1031.636,-212.7979;Float;False;True;-1;2;ASEMaterialInspector;0;0;StandardSpecular;Water;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;634;0;596;0
WireConnection;631;1;634;0
WireConnection;631;2;634;0
...
WireConnection;627;0;587;0
WireConnection;627;9;633;0
WireConnection;463;0;465;0
WireConnection;463;1;450;0
WireConnection;609;0;627;1
...
ASEEND*/
//CHKSM=DD4745FB8F36055D37C9BA04B8CB44061F62F960