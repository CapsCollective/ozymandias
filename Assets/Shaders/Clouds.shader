...
Shader "Custom/Clouds"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 panner34 = ( 1.0 * _Time.y * ( -temp_output_83_0 * float2( 0.01,0.01 ) ) + i.uv_texcoord);
...
/*ASEBEGIN
Version=18100
194;545;1577;602;3498.387;596.9969;1;True;True
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;31;-2839.221,-175.8287;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-875.2644,88.50191;Inherit;False;Property;_CloudOpacity;Cloud Opacity;3;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=A0DCBC015D4556EE59E82871473E701C9D52DE1F