...
Shader "Water"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( ase_vertex3Pos + appendResult31 ) * _WaveHeight );
			v.vertex.w = 1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float dotResult294 = dot( normalizeResult4_g23 , temp_output_447_0 );
			float temp_output_3_0_g25 = ( ( pow( max( 0.0 , dotResult294 ) , ( _Smoth * 100.0 ) ) * DistanceMask193 ) - _Float0 );
			o.Albedo = saturate( ( lerpResult48 + saturate( ( temp_output_3_0_g25 / fwidth( temp_output_3_0_g25 ) ) ) ) ).rgb;
...
/*ASEBEGIN
Version=18712
393;259;1445;774;2441.999;-41.24524;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;405;-1543.323,586.8987;Inherit;False;Property;_WaveNormalStrength;Wave Normal Strength;14;0;Create;True;0;0;0;False;0;False;0;-0.29;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;300;-759.4024,471.8353;Inherit;False;Blinn-Phong Half Vector;-1;;23;91a149ac9d615be429126c95e20753ce;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;192;-1262.553,-192.9543;Inherit;False;Property;_FarColor;Far Color;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.09899376,0.2862599,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;451;254.8238,209.9941;Inherit;False;Step Antialiasing;-1;;25;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;452;539.5082,320.6225;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;453;772.5656,397.3251;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;663.4988,597.8698;Inherit;False;Property;_WaveHeight;Wave Height;6;0;Create;True;0;0;0;False;0;False;1;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;58;749.1378,-1237.53;Inherit;True;Normal From Height;-1;;26;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;100;False;2;FLOAT3;40;FLOAT3;0
...
ASEEND*/
//CHKSM=83B2CD04BC505D3FFE75A6B38C9492D290ED9F9A